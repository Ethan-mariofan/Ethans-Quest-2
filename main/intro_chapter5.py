...
img1 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/1.png"))
img2 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/2.png"))
img3 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/3.png"))
img4 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/4.png"))
img5 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/5.png"))
img6 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/6.png"))
img7 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro5/7.png"))
 
chapter = pygame.image.load(os.path.join(GAME_PATH, "sprites/chapter_art/ch5/img.png"))
class IntroChapter5:
    def __init__(self, screen):
        ...
        self.cutscene = []  
        self.cutscene.append(CutsceneManager(103, pygame.Vector2(0, 0)))
