...
img1 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro6/1.png"))
img2 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro6/2.png"))
img3 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro6/3.png"))
img4 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro6/4.png"))
img5 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro6/5.png"))
img6 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro6/6.png"))

 
chapter = pygame.image.load(os.path.join(GAME_PATH, "sprites/chapter_art/ch6/img.png"))
class IntroChapter6:
    def __init__(self, screen):
        ...
        self.cutscene = []  
        self.cutscene.append(CutsceneManager(104, pygame.Vector2(0, 0)))
