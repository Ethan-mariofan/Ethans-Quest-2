...
img1 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/end/1.png"))
img2 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/end/2.png"))
img3 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/end/3.png"))
img4 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/end/4.png"))
img5 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/end/5.png"))
img6 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/end/6.png"))
...
class Ending:
    def __init__(self, screen):
        ...
        self.cutscene = []
        self.cutscene.append(CutsceneManager(105, pygame.Vector2(0, 0)))
        
        self.mscmgr = MusicManager(ENDING, True)
        self.mscmgr.play() 
        self.ch = True
