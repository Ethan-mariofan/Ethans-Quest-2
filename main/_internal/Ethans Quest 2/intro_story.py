...
img1 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro/1.png"))
img2 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro/2.png"))
img3 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro/3.png"))
img4 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro/4.png"))
img5 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro/5.png"))
img6 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro/6.png"))
 
chapter = pygame.image.load(os.path.join(GAME_PATH, "sprites/chapter_art/ch1/img.png"))
class IntroStory:
    def __init__(self, screen):
        ...
        self.cutscene = []
        self.cutscene.append(CutsceneManager(0, pygame.Vector2(0, 0)))
