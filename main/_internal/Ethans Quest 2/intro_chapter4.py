...
img1 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/1.png"))
img2 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/2.png"))
img3 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/3.png"))
img4 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/4.png"))
img5 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/5.png"))
img6 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/6.png"))
img7 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro4/7.png"))
 
chapter = pygame.image.load(os.path.join(GAME_PATH, "sprites/chapter_art/ch4/img.png"))
class IntroChapter4:
    def __init__(self, screen):
        ...
        self.cutscene = []  
        self.cutscene.append(CutsceneManager(102, pygame.Vector2(0, 0)))
