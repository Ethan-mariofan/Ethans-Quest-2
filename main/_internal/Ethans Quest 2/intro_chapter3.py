...
img1 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/1.png"))
img2 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/2.png"))
img3 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/3.png"))
img4 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/4.png"))
img5 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/5.png"))
img6 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/6.png"))
img7 = pygame.image.load(os.path.join(GAME_PATH, "sprites/cutscenes/intro3/7.png"))
 
chapter = pygame.image.load(os.path.join(GAME_PATH, "sprites/chapter_art/ch3/img.png"))
class IntroChapter3:
    def __init__(self, screen):
        ...
        self.cutscene = []  
        self.cutscene.append(CutsceneManager(101, pygame.Vector2(0, 0)))
